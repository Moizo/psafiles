...
function Q3No() {
    ...
    document.getElementById("question7").style.WebkitTransition = 'opacity 3s ease-in-out';
    document.getElementById("question7").style.opacity = "1";
}
//Question 4
function Q4Yes() {
...
function Q4No() {
    ...
    document.getElementById("question6").style.WebkitTransition = 'opacity 3s ease-in-out';
...
function Q7No() {
    ...
    document.getElementById("question8").style.WebkitTransition = 'opacity 3s ease-in-out';
    document.getElementById("question8").style.opacity = "1";
}
//Question 8
function Q8Yes() {
...
function Q8No() {
    ...
    document.getElementById("question9").style.WebkitTransition = 'opacity 3s ease-in-out';
    document.getElementById("question9").style.opacity = "1";
}
//Question 9
function Q9Yes() {
    document.getElementById("question9").style.display = "none";
    document.getElementById("question10").style.display = "block";
    document.getElementById("question10").style.WebkitTransition = 'opacity 3s ease-in-out';
    document.getElementById("question10").style.opacity = "1";
}
function Q9No() {
    document.getElementById("question9").style.display = "none";
}
...
function Q10No() {
    ...
    document.getElementById("question11").style.WebkitTransition = 'opacity 3s ease-in-out';
    document.getElementById("question11").style.opacity = "1";
}
//Question 11
function Q11Yes() {
...
function Q11No() {
    document.getElementById("questio11").style.display = "none";
}